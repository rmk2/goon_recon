...
(define-syntax tag
  (syntax-rules (/ class: id:)
    ...
    ((_ type /) (format #t "</~a> ~&" type))
    ((_ type class: class) (format #t "<~a class=\"~a\"> ~&" type class))
    ((_ type id: id) (format #t "<~a id=\"~a\"> ~&" type id))
    ((_ type field)
     (format #t "<~a>~a</~a> ~&" type field type))
    ((_ type field class: class)
     (format #t "<~a class=\"~a\">~a</~a> ~&" type class field type))
    ((_ type field id: id)
     (format #t "<~a id=\"~a\">~a</~a> ~&" type id field type))
    ((_ type field class: class id: id)
     (format #t "<~a class=\"~a\" id=\"~a\">~a</~a> ~&" type class id field type))))
